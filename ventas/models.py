...
class PedidoVenta(models.Model):
	...
	def get_valor_total(self):
		return sum(posicion.costoTotal for posicion in PedidoVentaPosicion.objects.filter(pedidoVenta  = self.idPedidoVenta))
...
class PosicionVentaCompra(models.Model):
	...
	def __str__(self):
		return '(%s) - (%s)' % (pedidoVentaPosicion,pedidoCompraPosicion)
