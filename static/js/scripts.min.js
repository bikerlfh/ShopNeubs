...
function getJSON(url,success,options=null){return $.ajax({dataType:"json",url:url,data:options!=null?options.data||null:null,method:options!=null?options.method||"GET":"GET",beforeSend:options!=null?options.beforeSend||null:null,success:success,error:function(jqXHR,estado,error){console.log(error);console.log(estado)},})}
