...
class PedidoCompraManager:
	...
	def save(self):
		...
		try:
			...
			self.pedidoCompra = PedidoCompra(proveedor=self.proveedor, estadoPedidoCompra=self.estadoPedidoCompra,
											 idUsuarioCreacion=self.usuario.pk)
			...
			movimientoInventario = MovimientoInventario(pedidoCompra=self.pedidoCompra,
														idUsuarioCreacion=self.usuario.pk)
